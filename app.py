...
if multiple_lines == "Yes": input_data["MultipleLines_Yes"] = 1
elif multiple_lines == "No phone service": input_data["MultipleLines_No phone service"] = 1
...
if 35 <= monthly_charges <= 70: input_data["ChargeRange_Mid (35–70)"] = 1
elif 70 < monthly_charges <= 120: input_data["ChargeRange_High (70–120)"] = 1
